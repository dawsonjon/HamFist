...
// filename: frame_buffer.cpp
// description: Frame buffer with graphics and text primitives
// License: MIT
//
...
void c_frame_buffer ::draw_line_antialiased(int x0, int y0, int x1, int y1, uint16_t colour,
                                            uint16_t alpha)
{
  bool one_point_in_view = (x0 >= 0 && x0 < m_width && y0 >= 0 && y0 < m_height) ||
                           (x1 >= 0 && x1 < m_width && y1 >= 0 && y1 < m_height);
  if (!one_point_in_view)
    return;
...
void c_frame_buffer ::draw_line(int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t colour,
                                uint16_t alpha)
{
  bool one_point_in_view = (x1 >= 0 && x1 < m_width && y1 >= 0 && y1 < m_height) ||
...
void c_frame_buffer::draw_string(uint16_t x, uint16_t y, const uint8_t* font, const char* s,
                                 uint16_t fg, uint16_t alpha)
{
...
void c_frame_buffer::draw_char(uint16_t x, uint16_t y, const uint8_t* font, char c, uint16_t fg,
                               uint16_t alpha)
{
...
void c_frame_buffer::fill_circle(uint16_t xc, uint16_t yc, uint16_t radius, uint16_t colour,
                                 uint16_t alpha)
{
...
void c_frame_buffer ::draw_circle(uint16_t xc, uint16_t yc, uint16_t radius, uint16_t colour,
                                  uint16_t alpha)
{
...
void c_frame_buffer ::draw_rect(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t colour,
                                uint16_t alpha)
{
...
void c_frame_buffer ::fill_rect(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t colour,
                                uint16_t alpha)
{
...
void c_frame_buffer ::draw_image(uint16_t x, uint16_t y, uint16_t w, uint16_t h,
